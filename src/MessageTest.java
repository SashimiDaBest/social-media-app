...
public class MessageTest {
    ...
    public void testGetAuthorID() {
        ...
        assertEquals("testGetAuthorID: Returned authorID shouldn't match the one in the constructor when they aren't equal", false, result2);
    }
    ...
    public void testGetMessageType() {
        ...
        assertEquals("testGetMessageType: Returned message type shouldn't match the one in the constructor when they aren't equal", false, result2);
    }
    ...
    public void testSetMessage() {
        ...
        assertEquals("testSetMessage: function should return true upon successful mutation", true, funcResult1);
        assertEquals("testSetMessage: the message's current content was not the one it was assigned to be changed to", true, correctParam1);
        ...
        assertEquals("testSetMessage: function should return false upon unsuccessful mutation", false, funcResult2);
        assertEquals("testSetMessage: the message's content should not change upon unsuccessful mutation", true, correctParam2);
    }
