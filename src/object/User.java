...
//        }
        ...
        this.accountType = 0;
        this.serverPhotoPathway = "I_0000";
        ...
        try (PrintWriter pw = new PrintWriter(new FileWriter(sampleFolder + this.userID + ".txt"))) {
    ...
    public synchronized void writeData() {
        try (PrintWriter pr = new PrintWriter(new FileWriter(sampleFolder + this.getUserID() + ".txt"))) {
    ...
    public String createPhotoID() {
        String id = "P_";
        String[] splitter = this.userID.split("");
